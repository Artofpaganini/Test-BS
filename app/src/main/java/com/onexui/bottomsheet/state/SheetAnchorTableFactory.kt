...
// Rest-якоря для settle (без Hidden): fill → Collapsed(peek)/ExpandedFullScreen + кастомные; wrap → Content /
// Collapsed+ExpandedContent по контенту. distinctBy+sortedBy по px.
